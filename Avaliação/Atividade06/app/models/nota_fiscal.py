...
class NotaFiscal:
    ...
    def imprimirNotaFiscal(self):
        ...
        texto = f'' \
                ...
                f'CPF/CNPJ: {self.__cliente.get_cnpjcpf()}\n' \
                f'{linha}\n' \
                f'ITENS\n' \
                f'{linha}\n' \
        ...
        for x in self.__itens:
            print(f'  {x.get_seq():<9d}{x.get_descricao():<28s}{x.get_qtd():<11d}{x.get_valor_unit():<18.2f}'
    ...
    def dicionario(self):
        return {'id': self.get_id(),
                ...
                'data': self.get_data(),
                'cliente': self.get_cliente().dicionario(),
                'itens': [i.dicionario() for i in self.__itens],
